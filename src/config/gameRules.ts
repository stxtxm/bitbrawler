export const GAME_RULES = {
    ...
    PVE: {
        ...
        STAT_MULTIPLIER: 4.5, // Monster stat multiplier for challenging fights (target ~65-75% win rate)
        HP_MULTIPLIER: 5.0, // Monster HP multiplier for longer, suspenseful battles
