...
describe('CombatView Animation Overhaul', () => {
    ...
    // ─── Stage 10: Special floating text ────────────────────
    ...
    it('should emit blocked particle on regular hit action', () => {
>>>>>>> c109ba6 (feat: [3/4] two-stage health bar, enhanced combat VFX, particle types)
        vi.useFakeTimers();
