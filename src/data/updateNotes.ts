...
export const UPDATE_NOTES: UpdateNote[] = [
  {
    version: '2.3.0',
    date: '2026-05-25',
    title: 'Workflow unification, agent documentation & CI performance',
    changes: [
      'All GitHub Actions workflows normalized to v4 (checkout, setup-node) with npm caching for faster CI.',
      'New opencode agent documentation: dev-agent, reviewer, tech-lead, and qa-tester with structured workflows and strict rules.',
      'Reviewer agent: expanded checklist with priority levels (critique/important/mineur) and decision rules for approve/merge or request-changes.',
      'Tech-lead agent: detailed daily workflow with mineure vs majeure issue distinction, QA stats analysis, and web research for inspiration.',
      'QA-tester agent: E2E Playwright workflow with verification checklist and stats collection schema.',
      'Dev-agent: clarified GitHub Actions auto-PR workflow, added tips for test/build verification before push.',
      'Improved YAML indentation, PR_NUMBER extraction, and logging across all workflows.',
      'Added NOTES.md with comprehensive project documentation (data model, combat rules, matchmaking, bots, infrastructure).',
      'Added MIGRATION_STATUS.md, .env.example, eslint.config.js, and typed tsconfig with strict mode.',
      'Service worker (public/sw.js), PWA manifest, and touch icons added for progressive web app support.',
      'Agent configs consolidated in opencode.json.',
    ],
  },
  {
    version: '2.2.0',
