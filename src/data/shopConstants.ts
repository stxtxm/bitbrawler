 ...
 * - Target: first purchase in ~3-5 days → cheapest offer ≈ 18 (≈3.8 days)
 * - Coffre mystère EV ≈ 43 (LOOTBOX_RARITY_WEIGHTS × ESSENCE_YIELD) → 31
...
export const SHOP_OFFERS: ShopOfferConfig[] = [
  { type: 'item', price: 18, label: 'Marchandise', rarityPool: ['common', 'uncommon', 'rare'] },
  { type: 'item', price: 36, label: 'Pièce rare', rarityPool: ['rare', 'epic'] },
  { type: 'lootbox', price: 31, label: 'Coffre mystère', rarityPool: null },
  { type: 'item', price: 54, label: 'Objet épique', rarityPool: ['epic'] },
];
