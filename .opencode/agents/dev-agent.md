...
3. Utilise: `gh issue create --title "feat: [sub-task N/M] Description" --body "Description... /oc" --label auto-generated --label sub-issue`
...
6. **NE PAS** commencer à coder — c'est interdit

**EXEMPLE**:
```bash
# ✅ BON: créer les sous-issues, STOP
gh issue create --title "feat: [1/3] Forge Foundation" --body "... /oc" --label auto-generated
gh issue create --title "feat: [2/3] Forge UI" --body "... /oc" --label auto-generated
gh issue create --title "feat: [3/3] Forge finalization" --body "... /oc" --label auto-generated
