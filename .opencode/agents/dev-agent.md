...
3. Commence par implémenter la première sous-tâche
4. Utilise: `gh issue create --title "Sous-tâche: [description]" --body "Description... /oc"`
5. **NE PAS DEMANDER** "Souhaitez-vous que je procède" — FAIS-LE, c'est tout
